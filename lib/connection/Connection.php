...
class Connection {
    ...
    private static $dns = 'mysql:dbname=daverdz_deliroll;host=127.0.0.1'; //65.19.141.67
    private static $user = 'root'; //daverdz_deliroll
    private static $password = 'root'; //delirollitz
